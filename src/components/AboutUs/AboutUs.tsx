...
const VALUES = [
  { title: "Converge", desc: "At An Industry Trade Show", color: "#e41c62" },
  { title: "Accentuate", desc: "Your Brand", color: "#5CC6D0" },
  { title: "Connect", desc: "With B2B Professional Buyers", color: "#BAD94A" },
  { title: "Network", desc: "With Stakeholders Industry", color: "#e41c62" },
  { title: "Penetrate", desc: "And Tap Potential Markets", color: "#FFCC29" },
  { title: "Collaborate", desc: "And Scale", color: "#BAD94A" }
];
    ...
    <section ref={containerRef} className="relative w-full bg-[#f0f0f0] font-sans text-black overflow-hidden border-b-[1.5px] border-[#DFDFDF]">
      ...
      <div className="w-[95%] mx-auto px-6 pt-8 md:px-12 border-x-[1.5px] border-[#DFDFDF]">
        <CylinderText 
          text="About Wofx" 
          trigger="viewport"
          className="text-[12vw] font-display font-black leading-none tracking-tighter md:text-[8vw] text-left"
          primaryColor="#e41c62"
        />
      </div>
          ...
          {VALUES.map((value, idx) => (
            <div key={value.title} className="flex flex-col">
              <PaperFold 
                text={value.title}
                type="chars"
                className="text-3xl font-sans font-black md:text-4xl lg:text-5xl leading-none"
